...
public class JPanelVictory extends JPanel {
	...
	public void paint(Graphics g) {
		...
		g.drawImage(new ImageIcon(getClass().getResource("/img/victory.png")).getImage(), (getWidth() / 2) - 100, (getHeight() / 2) + 100, 200, 100, this);
